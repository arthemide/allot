...
def upgrade() -> None:
    ...
    op.add_column('stocks', sa.Column('asset_type', sa.String(length=20), nullable=False, server_default='stock'))
    op.add_column('stocks', sa.Column('base_prum', sa.Numeric(precision=20, scale=10), nullable=True))
    ...
    op.create_index('idx_asset_timestamp', 'asset_transactions', ['asset_id', 'timestamp'])
