...
class DCAScheduler:
    ...
    def setup_schedule(self):
        ...
        if dca_config.days_of_month:
            ...
            logger.error("❌ No valid scheduling configuration found (DCA_DAYS_OF_MONTH is required)")
        ...
        self.scheduler.add_job(
            ...
            misfire_grace_time=86400 * 7,  # Allow 7 days grace period for missed executions
        )
        
        logger.info("✅ Scheduler configured successfully")
        logger.info(f"ℹ️  Misfire grace period: 7 days (missed executions will run on next startup within 7 days)")
